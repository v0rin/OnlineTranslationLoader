...
public class Sources {
    ...
    public static final String LINGUEE_SOURCE = "linguee";
    public static final String COLLINS_SOURCE = "collins";
    public static final String SYNONIM_NET_SOURCE = "synonim-net";
}
